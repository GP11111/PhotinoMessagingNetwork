...
class SocketListener extends Thread
{
	...
	public SocketListener(int socketnum, DatagramSocket socketIn, DatagramSocket socketOut, int port ) 
	{
		...
		int portIn = 0;
		byte[] receiveDataIn = new byte[PhotinoQue.udppacketsize];
		String contentIn = "";
		...
		{ 
		  ...
		  try
		  {
			  receiveDataIn = new byte[PhotinoQue.udppacketsize];
		      ...
		      if ( !PhotinoQue.blacklistip.containsKey(IPAddressIn.getHostAddress()) )
		      {
		    	  //
